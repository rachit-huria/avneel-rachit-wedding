...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function openInvitation(){
    ...
    // Music must start synchronously inside the click handler — any delay
    // (even via setTimeout) causes browsers to block autoplay as not being
    // a direct response to the user's tap.
    attemptPlayMusic();
  ...
  /* ---------- Lightbox (RSVP form integration) ---------- */
